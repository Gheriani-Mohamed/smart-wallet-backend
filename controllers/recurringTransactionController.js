...
exports.createRecurringTransaction = async (req, res) => {
  try {
    ...
    // Parse dates at noon (12:00) to avoid timezone conversion issues
    ...
    const recurringTransaction = await prisma.recurringTransaction.create({
      data: {
        ...
        lastGenerated: parseDate(startDate), // Initialize to start date
        isActive: true,
      },
      include: {
        wallet: {
    ...
    const recurringTransaction = await prisma.recurringTransaction.findUnique({
      ...
      include: {
        ...
        transactions: {
          ...
          take: 10, // Last 10 generated transactions
        },
      },
    });
    ...
    if (recurringTransaction.type === 'expense') {
      ...
      if (budget) {
        const updatedBudget = await prisma.budget.update({
          ...
          data: {
            currentSpent: {
              increment: recurringTransaction.amount,
            },
          },
        });
